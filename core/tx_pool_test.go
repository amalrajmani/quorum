...
func setupTxPool() (*TxPool, *ecdsa.PrivateKey) {
	...
	pool := NewTxPool(testTxPoolConfig, params.TestChainConfig, blockchain, "dummy")
...
func setupQuorumTxPool() (*TxPool, *ecdsa.PrivateKey) {
	...
	key, _ := crypto.GenerateKey()
	pool := NewTxPool(testTxPoolConfig, params.QuorumTestChainConfig, blockchain, "dummy")
...
func testTransactionQueueGlobalLimiting(t *testing.T, nolocals bool) {
	...
	pool := NewTxPool(config, params.TestChainConfig, blockchain, "dummy")
	defer pool.Stop()
...
func TestEIP155SignerOnTxPool(t *testing.T) {
	...
	for _, tt := range flagtests {
		t.Run("", func(t *testing.T) {
			...
			pool := NewTxPool(testTxPoolConfig, chainconfig, blockchain, "dummy")
